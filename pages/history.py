...
from streamlit import set_page_config,markdown,session_state,switch_page
from elements import navbar

if __name__ == "__main__":
    set_page_config(page_title="Historial", page_icon="📈",layout="wide")
    if "session" not in session_state or not session_state.session.is_active():
